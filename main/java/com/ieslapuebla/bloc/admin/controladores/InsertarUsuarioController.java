...
public class InsertarUsuarioController implements Initializable {
    ...
    public static final Border BORDE_ROJO = new Border(new BorderStroke(Color.RED, BorderStrokeStyle.SOLID,
            new CornerRadii(3), new BorderWidths(1)));
    public static final Border BORDE_VERDE = new Border(new BorderStroke(Color.GREEN, BorderStrokeStyle.SOLID,
            new CornerRadii(3), new BorderWidths(1)));
    ...
    private void guardarUsuario(ActionEvent event) {
        ...
        if (usuario.isEmpty() || contraseña.isEmpty() || email.isEmpty() || nombre.isEmpty()) {
            ...
            Usuario nuevoUsuario = new Usuario(usuario, contraseña, email, nombre);
    ...
    private void validarContrasena(String contrasena) {
        ...
        } else if (!contrasena.matches(PATRON_CONTRASENA) || (contrasena.length() > 8 || contrasena.length() < 8)) {
    ...
    private void validarNombre(String nombreCompleto) {
        ...
        } else if (!nombreCompleto.matches(PATRON_NOMBRE)) {
